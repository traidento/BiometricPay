...
public class SmoothMarkDrawerCheckBox extends SmoothMarkDrawer {
    ...
    private final PorterDuffXfermode xfermode = new PorterDuffXfermode(PorterDuff.Mode.DST_OUT);// XOR);
    private final Interpolator interpolator = new FastOutSlowInInterpolator();
    private final RectF mCheckRectF;
    private final RectF mCheckClearRectF;
    private final Path mCheckHookPath;
    /**
     * 对号的3个关键点坐标
     **/
    private final float[] HOOK_X = new float[]{0.31481f, 0.43915f, 0.68783f};
    private final float[] HOOK_Y = new float[]{0.475f, 0.61111f, 0.35450f};
