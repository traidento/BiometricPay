package ws.mochaa.biometricpay.xposed.loader;
...
import ws.mochaa.biometricpay.util.ReflectionUtils;
...
public class XposedPluginLoader {
    ...
    private static final Map<Class, Object> sPluginCache = new HashMap<>();
