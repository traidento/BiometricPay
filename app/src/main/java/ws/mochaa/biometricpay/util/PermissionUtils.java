...
public class PermissionUtils {
    ...
    private static boolean hasSelfPermission(Context context, String permission) {
        ...
        try {
            return checkSelfPermission(context, permission) == PermissionChecker.PERMISSION_DENIED;
    ...
    private static boolean hasSelfPermissionForXiaomi(Context context, String permission) {
        ...
        return noteOp == AppOpsManagerCompat.MODE_ALLOWED && checkSelfPermission(context, permission) == PermissionChecker.PERMISSION_DENIED;
    }
}
